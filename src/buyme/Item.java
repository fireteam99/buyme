...
public class Item {
	...
	public ResultSet getByCategory(String category) throws SQLException {
	...
	public ResultSet getBySubcategory(String subcategory) throws SQLException {
	...
	public static void main(String[] args) {
		...
		Item item = new Item();
		try {
			ResultSet rs = item.search("phone", "electronics", "", 0, 0, 0);
		} catch (SQLException se) {
			se.printStackTrace();
		} catch (Exception e) {
			e.printStackTrace();
